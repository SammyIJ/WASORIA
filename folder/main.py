...
from operations.pixel_itensity_sum import load_and_preprocess_mnist, compute_pca_and_predict_intensity, plot_predictions
...
def main():
    ...
    if args.run == "svd":
        ...
        run_pca()
    elif args.run == "pis":  # New option for running pixel intensity sum prediction
        run_pis()
